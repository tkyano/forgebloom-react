...
const VideoSlideshow = () => {
  ...
  const videos = [
    { title: "Edge of Eternities - Launch Trailer" },
    { title: "Edge of Eternities - Deck Building Tips" },
    { title: "Edge of Eternities - Gameplay Highlights" },
  ];
  ...
  return (
    <section id="video-slideshow">
      ...
      <Video title={videos[videoIndex].title} />
